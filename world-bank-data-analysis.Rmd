...
values and last 5 rows were dropped.
...
years in countries grouped by continents. It shows that in general, countries
with higher GDP tend to have a higher life expectancy.
```{r}
wdi_continents_df %>%
...
On the plot below, all correlations with gold price higher than 0.6
were presented. Below the plot, the same data was presented in table form.
```{r fig.height=9}
...
Data set was split into training and testing partitions in 70/30 ratio. 
