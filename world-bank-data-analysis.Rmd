...
imputed_df <- miss_forest$ximp %>%
  ...
  cbind(`Gold price (USD)` = world_joined_df$`Gold price (USD)`)
...
of the training and test data. Since data consists only of `r nrow(imputed_df)`
observations, there is some discrepancy between training and testing data
partitions.
```{r}
ggplot() +
